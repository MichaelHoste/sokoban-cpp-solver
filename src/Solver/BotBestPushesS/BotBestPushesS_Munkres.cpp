...
#include "../../../include/Solver/BotBestPushesS/BotBestPushesS_Munkres.h"
...
bool
BotBestPushesS_Munkres::find_uncovered_in_matrix(double item, int &row, int &col) {
...
bool
BotBestPushesS_Munkres::pair_in_list(const std::pair<int,int> &needle, const std::list<std::pair<int,int> > &haystack) {
...
int
BotBestPushesS_Munkres::step1(void) {
...
int
BotBestPushesS_Munkres::step2(void) {
	int covercount = 0;
	for ( int row = 0 ; row < matrix.rows() ; row++ )
		for ( int col = 0 ; col < matrix.columns() ; col++ )
...
int
BotBestPushesS_Munkres::step3(void) {
	/*
	Main Zero Search
...
int
BotBestPushesS_Munkres::step4(void) {
...
int
BotBestPushesS_Munkres::step5(void) {
	/*
...
int*
BotBestPushesS_Munkres::solve(BotBestPushesS_Matrix<double> &m) {
	...
	int* posTab = (int*)malloc(matrix.rows()*sizeof(int));
	int posTabLength=0;
	// Store results
	for ( int row = 0 ; row < matrix.rows() ; row++ )
		for ( int col = 0 ; col < matrix.columns() ; col++ )
